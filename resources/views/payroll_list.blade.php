                  ...
                  <button type="submit" class="btn btn-primary">Create</button>
                    ...
                    <script type="text/javascript">  
                      function print_row(e,cell)                      
                      {
                       ...
                       function print_invoice(e,cell)                      
                      {
                       var id=cell.getRow().getData().id;
                       let url = 'invoice_print/'+id+'';
                       document.location.href=url;
                      } 
                    ...
                    {
                    return "<i class='mdi mdi-cloud-print-outline'></i>"; 
                    };

                      var invoiceIcon = function(cell, formatterParams, onRendered)
                    {
                    return "<i class='mdi mdi-cloud-print '></i>"; 
                    };
                      ...
                      columns:[
                          ...
                          {formatter:invoiceIcon, width:40, hozAlign:"center", headerSort:false, cellClick:function(e, cell){
                            print_invoice(e,cell);
                          }},
